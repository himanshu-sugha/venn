...
describe('Transaction Visualization Demo', () => {
  // This will only run when explicitly called with --testNamePattern="Visualization"
  test('Generate visual report for example transactions', () => {
    ...
    console.log('Open the HTML report in your browser to view detailed visualizations.');
    console.log('Look for the file at: tests/reports/transaction-examples-report.html');
    console.log('==============================================================\n');
    
    // This is just a dummy expectation to make Jest happy
